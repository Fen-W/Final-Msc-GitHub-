# Looks up what the AI wrote about one picture in the first database.
...
captions = json.load(open("/Users/woolf/Desktop/dissertation/build_v2/figure_captions_cache.json"))
...
print("build_v2/extracted_figures/" + document + "/" + image_file)
